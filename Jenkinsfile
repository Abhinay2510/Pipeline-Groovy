...
pipeline {
    ...
    success {
        script {
           ...
           curl -v -u admin:admin --upload-file "C:\ProgramData\Jenkins\.jenkins\workspace\3ibank\flexib@2\sast-report-57.zip" "http://10.1.127.197:8081/repository/Flexib-Reports/sast-report/sast-report-57.zip"
